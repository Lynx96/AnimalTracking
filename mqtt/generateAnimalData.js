...
function generateAnimalData() {
    ...
    const latitude = new BigNumber((Math.random() * 180 - 90)).shiftedBy(15).toString(); // Generate a random latitude between -90 and 90
    const longitude = new BigNumber((Math.random() * 360 - 180)).shiftedBy(15).toString(); // Generate a random longitude between -180 and 180
